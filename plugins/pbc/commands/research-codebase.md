---
description: Document codebase as-is with cited references through parallel sub-agent research
...
5. **Gather metadata for the research document:**
   - Gather metadata directly from standard commands (do not assume helper scripts exist):
     - Current datetime (ISO with timezone)
